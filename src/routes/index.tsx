...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cafe minimalis dengan kopi hangat berkualitas, suasana tenang, dan keramahan khas. Pesan via ojol favoritmu." },
      { property: "og:title", content: "Koopiantese.id — Secangkir Hangat, Sejuta Cerita" },
      { property: "og:description", content: "Cafe minimalis dengan kopi hangat berkualitas dan suasana tenang." },
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          ...
          >
            <p className="mb-5 text-[11px] uppercase tracking-[0.32em] text-[var(--brown)]">Koopiantese · Est. Cafe</p>
      ...
      <section className="border-t border-black/5 bg-white/40 py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <p className="mb-4 text-[11px] uppercase tracking-[0.32em] text-[var(--brown)]">Pesan & Kontak</p>
            <h2 className="font-serif text-3xl text-[var(--navy)] md:text-4xl">
              Kemudahan Pesan via Ojol <span className="italic text-[var(--brown)]">& Info Cafe</span>
            </h2>
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { name: "GoFood", desc: "Pesan cepat lewat aplikasi Gojek.", logo: gofood, url: "https://gofood.co.id/" },
              { name: "GrabFood", desc: "Antar nyaman bersama Grab.", logo: grabfood, url: "https://r.grab.com/o/ENNRRRBz" },
              { name: "ShopeeFood", desc: "Diskon spesial via ShopeeFood.", logo: shopeefood, url: "https://spf.shopee.co.id/3VhSWSbojx" },
            ].map((c, i) => (
              <motion.a
                key={c.name}
                href={c.url}
              ...
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-[var(--navy)]/5">
                  <img src={c.logo} alt={c.name} className="h-9 w-auto object-contain" loading="lazy" />
                </div>
            ...
            >
              ...
              <p className="mt-1 text-sm leading-relaxed text-[var(--ink)]/60">Chat langsung dengan tim kami.</p>
              <div className="mt-auto inline-flex items-center gap-1 pt-4 text-sm text-[var(--navy)]">
                Hubungi
                <span className="transition-transform group-hover:translate-x-0.5">→</span>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-10 md:grid-cols-3">
            {pillars.map((p, i) => (
              ...
              >
                <div className="text-[11px] uppercase tracking-[0.3em] text-[var(--brown)]">0{i + 1}</div>
