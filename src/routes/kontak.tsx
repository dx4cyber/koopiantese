...
export const Route = createFileRoute("/kontak")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kunjungi Koopiantese.id, sapa kami di Instagram & TikTok @koopiantese.id, atau hubungi langsung via WhatsApp." },
    ...
    <div>
      <section className="mx-auto max-w-6xl px-6 py-20 md:py-28">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="mb-5 text-[11px] uppercase tracking-[0.32em] text-[var(--brown)]">Kontak & Sosial</p>
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-5">
          ...
          >
            <div className="rounded-2xl border border-black/5 bg-white p-7">
              <p className="text-[11px] uppercase tracking-[0.3em] text-[var(--brown)]">Sosial Media</p>
            ...
            >
              <div>
                <p className="text-[11px] uppercase tracking-[0.3em] text-[var(--cream)]/60">WhatsApp</p>
